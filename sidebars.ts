  ...
  mainSidebar: [
    ...
    },
    {
      ...
      items: [
        'modules/overview',
        {
          // The reference page itself stays where it was; the per-module detail
          // pages hang under it, generated from content/modules/reference/ so a
          // new page never has to be added here by hand.
          type: 'category',
          label: 'Module reference',
          link: { type: 'doc', id: 'modules/reference' },
          collapsed: true,
          items: [{ type: 'autogenerated', dirName: 'modules/reference' }],
        },
        'modules/free-core',
        'modules/premium',
